 ...
 */
final class Version20251105154532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT NOT NULL, project_name VARCHAR(255) NOT NULL, project_description VARCHAR(255) NOT NULL, project_created_at DATE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE th (id INT NOT NULL, th_change_log VARCHAR(255) NOT NULL, th_update_at DATE NOT NULL, PRIMARY KEY(id))');
